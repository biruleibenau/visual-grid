...
itemProto.getSize = function() { this.size = getSize( this.element ); };
...
LayoutMode.prototype._getItemLayoutPosition = function() { return { x: 0, y: 0 }; };
LayoutMode.prototype._manageStamp = function() {};
LayoutMode.prototype._getContainerSize = function() { return {}; };
LayoutMode.prototype.needsResizeLayout = function() { return false; };
LayoutMode.modes = {};
...
proto._getFilterTest = function( filter ) {
  if ( window.jQuery && this._getOption('isJQueryFiltering') ) {
    return function( item ) { return jQuery( item.element ).is( filter ); };
  }
